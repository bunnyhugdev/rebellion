...
function custom_post_example() { 
	...
	register_post_type( 'custom_type', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			'name' => __( 'Custom Types', 'rebelliontheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Custom Post', 'rebelliontheme' ), /* This is the individual type */
			'all_items' => __( 'All Custom Posts', 'rebelliontheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'rebelliontheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Custom Type', 'rebelliontheme' ), /* Add New Display Title */
			...
			'description' => __( 'This is the example custom post type', 'rebelliontheme' ), /* Custom Type Description */
			'public' => true,
